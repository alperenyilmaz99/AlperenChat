...
import com.example.alperenchat.databinding.ActivitySignUpBinding;
...
public class SignUpActivity extends AppCompatActivity {
    ...
    private void signUp() {
        ...
        user.put(Constans.KEY_EMAİL,binding.inputEmail.getText().toString());
    ...
    private Boolean isValidSignUpDetails()
    {
        ...
        if (encodedImage==null){
            ...
            showToast("Enter again Password");
        }
